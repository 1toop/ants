--[[
a bit diff mercury lib i rewrote it a bit
by .toop
Discord: discord.gg/BcnxDQa32N
]]
...
function Library:textbox(options)
	...
	textBox.Size = UDim2.fromOffset(math.max(textBox.TextBounds.X + 20, 150), 20)
		...
		textBox.Focused:connect(function()
			...
			while focused and RunService.RenderStepped:wait() do
				textBox.AbsoluteObject:TweenSize(
					UDim2.fromOffset(math.clamp(textBox.TextBounds.X + 20, 150, 0.6 * textboxContainer.AbsoluteSize.X), 20),
